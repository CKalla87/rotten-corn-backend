...
class ChatWorker {
  public async addChatMessageToDB(jobQueue: Job, done: DoneCallback): Promise<void> {
    try {
  ...
  public async markMessageAsDeleted(jobQueue: Job, done: DoneCallback): Promise<void> {
    try {
  ...
  public async markMessagesAsRead(jobQueue: Job, done: DoneCallback): Promise<void> {
    try {
  ...
  public async updateMessageReaction(jobQueue: Job, done: DoneCallback): Promise<void> {
    try {
