...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    ...
    it('should call updateSingleUserItemInCache method', async () => {
      ...
      const url = 'https://res.cloudinary.com/dajmo61zu/image/upload/v1234/123456';
    ...
    it('should call addImageJob method', async () => {
      ...
      expect(imageQueue.addImageJob).toHaveBeenCalledWith('addUserProfileImageToDB', {
        ...
        value: 'https://res.cloudinary.com/dajmo61zu/image/upload/v1234/123456',
        imgId: '123456',
        imgVersion: '1234'
      });
      expect(res.status).toHaveBeenCalledWith(200);
  ...
  describe('backgroundImage', () => {
    ...
    it('should return bad request error', async () => {
      ...
      await expect(Add.prototype.backgroundImage(req, res)).rejects.toThrowError('Upload error');
    });
